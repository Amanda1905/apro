...
class HistoryLabuh extends StatefulWidget {
  const HistoryLabuh({super.key});

  @override
  State<HistoryLabuh> createState() => _HistoryLabuhState();
}

class _HistoryLabuhState extends State<HistoryLabuh> {
  int selectedIndex = 1;

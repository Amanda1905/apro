import 'package:apro/presentation/constant/history_list.dart';
import 'package:apro/presentation/constant/theme.dart';
import 'package:apro/presentation/pages/history_labuh.dart';
import 'package:apro/presentation/pages/history_tambat.dart';
import 'package:apro/presentation/pages/history_yatch.dart';
import 'package:apro/presentation/pages/home_screen.dart';
import 'package:apro/presentation/pages/profil_screen.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:google_nav_bar/google_nav_bar.dart';

class HistoryAirbersih extends StatefulWidget {
  const HistoryAirbersih({super.key});

  @override
  State<HistoryAirbersih> createState() => _HistoryAirBersihState();
}

class _HistoryAirBersihState extends State<HistoryAirbersih> {
  int selectedIndex = 1;
